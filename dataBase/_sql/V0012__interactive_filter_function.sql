...
-- other
    ...
    and (
        ...
        or exists (
            select 1 from interactive_active.languages as l
            where l.id = v.id
            and (
                (p_languages is null or cardinality(p_languages) = 0)
                or
    ...
    and (
        ...
        or exists (
            select 1 from interactive_active.locations as l
            where l.id = v.id
            and (
                (p_location_regions is null or cardinality(p_location_regions) = 0)
                or
    ...
    and (
        ...
        or exists (
            select 1 from interactive_active.fields as f
    ...
    and (
        ...
        or exists (
            select 1 from interactive_active.grades as g
    ...
    and (
        ...
        or exists (
            select 1 from interactive_active.schedules as s
    ...
    and (
        ...
        or exists (
            select 1 from interactive_active.skills as s
